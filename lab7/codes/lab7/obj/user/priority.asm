...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	74450513          	addi	a0,a0,1860 # 800778 <main+0x1c0>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	74450513          	addi	a0,a0,1860 # 800798 <main+0x1e0>
...
exit(int error_code) {
  ...
  800156:	64e50513          	addi	a0,a0,1614 # 8007a0 <main+0x1e8>
...
0000000000800174 <lab6_set_priority>:
}
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8001ca:	81278793          	addi	a5,a5,-2030 # 8009d8 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  80021e:	59aa0a13          	addi	s4,s4,1434 # 8007b4 <main+0x1fc>
  ...
  80022a:	6eac0c13          	addi	s8,s8,1770 # 800910 <error_string>
  ...
  800318:	7b460613          	addi	a2,a2,1972 # 800ac8 <error_string+0x1b8>
  ...
  8004ac:	61060613          	addi	a2,a2,1552 # 800ab8 <error_string+0x1a8>
  ...
  8004be:	5f660613          	addi	a2,a2,1526 # 800ab0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  8004c2:	00000417          	auipc	s0,0x0
  8004c6:	5ef40413          	addi	s0,s0,1519 # 800ab1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  800552:	56340413          	addi	s0,s0,1379 # 800ab1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  ...
  8005ee:	b87ff0ef          	jal	ra,800174 <lab6_set_priority>
  ...
  800604:	c969                	beqz	a0,8006d6 <main+0x11e>
          ...
          if (pids[i] < 0) {
  800606:	12054d63          	bltz	a0,800740 <main+0x188>
     for (i = 0; i < TOTAL; i ++) {
  ...
  800620:	4d450513          	addi	a0,a0,1236 # 800af0 <error_string+0x1e0>
  ...
  800638:	4e4b8b93          	addi	s7,s7,1252 # 800b18 <error_string+0x208>
         waitpid(pids[i],&status[i]);
  ...
  8006b6:	0e650513          	addi	a0,a0,230 # 800798 <main+0x1e0>
  ...
  8006e0:	6909                	lui	s2,0x2
               lab6_set_priority(i + 1);
  8006e2:	a93ff0ef          	jal	ra,800174 <lab6_set_priority>
                    if(acc[i]%4000==0) {
  8006e6:	fa04849b          	addiw	s1,s1,-96
               acc[i] = 0;
  8006ea:	00042023          	sw	zero,0(s0)
                        if((time=gettime_msec())>MAX_TIME) {
  8006ee:	71090913          	addi	s2,s2,1808 # 2710 <_start-0x7fd910>
  8006f2:	4014                	lw	a3,0(s0)
  8006f4:	2685                	addiw	a3,a3,1
     for (i = 0; i != 200; ++ i)
  8006f6:	0c800713          	li	a4,200
          j = !j;
  8006fa:	47b2                	lw	a5,12(sp)
  8006fc:	377d                	addiw	a4,a4,-1
  8006fe:	2781                	sext.w	a5,a5
  800700:	0017b793          	seqz	a5,a5
  800704:	c63e                	sw	a5,12(sp)
     for (i = 0; i != 200; ++ i)
  800706:	fb75                	bnez	a4,8006fa <main+0x142>
                    if(acc[i]%4000==0) {
  800708:	0296f7bb          	remuw	a5,a3,s1
  80070c:	0016871b          	addiw	a4,a3,1
  800710:	c399                	beqz	a5,800716 <main+0x15e>
  800712:	86ba                	mv	a3,a4
  800714:	b7cd                	j	8006f6 <main+0x13e>
  800716:	c014                	sw	a3,0(s0)
                        if((time=gettime_msec())>MAX_TIME) {
  800718:	a59ff0ef          	jal	ra,800170 <gettime_msec>
  80071c:	0005099b          	sext.w	s3,a0
  800720:	fd3959e3          	ble	s3,s2,8006f2 <main+0x13a>
                            cprintf("child pid %d, acc %d, time %d\n",getpid(),acc[i],time);
  800724:	a49ff0ef          	jal	ra,80016c <getpid>
  800728:	4010                	lw	a2,0(s0)
  80072a:	85aa                	mv	a1,a0
  80072c:	86ce                	mv	a3,s3
  80072e:	00000517          	auipc	a0,0x0
  800732:	3a250513          	addi	a0,a0,930 # 800ad0 <error_string+0x1c0>
  800736:	96bff0ef          	jal	ra,8000a0 <cprintf>
                            exit(acc[i]);
  80073a:	4008                	lw	a0,0(s0)
  80073c:	a0fff0ef          	jal	ra,80014a <exit>
  800740:	00001417          	auipc	s0,0x1
  800744:	90440413          	addi	s0,s0,-1788 # 801044 <pids+0x14>
          if (pids[i] > 0) {
  800748:	00092503          	lw	a0,0(s2)
  80074c:	00a05463          	blez	a0,800754 <main+0x19c>
               kill(pids[i]);
  800750:	a19ff0ef          	jal	ra,800168 <kill>
  800754:	0911                	addi	s2,s2,4
     for (i = 0; i < TOTAL; i ++) {
  800756:	ff2419e3          	bne	s0,s2,800748 <main+0x190>
     panic("FAIL: T.T\n");
  80075a:	00000617          	auipc	a2,0x0
  80075e:	41e60613          	addi	a2,a2,1054 # 800b78 <error_string+0x268>
  800762:	04b00593          	li	a1,75
  800766:	00000517          	auipc	a0,0x0
  80076a:	42250513          	addi	a0,a0,1058 # 800b88 <error_string+0x278>
  80076e:	8b9ff0ef          	jal	ra,800026 <__panic>
